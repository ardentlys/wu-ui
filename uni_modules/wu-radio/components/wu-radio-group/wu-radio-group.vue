...
<script>
	...
	/**
	 * radioRroup 单选框父组件
	 * @description 单选框用于有一个选择，用户只能选择其中一个的场景。搭配wu-radio使用
	 ...
	 * @example <wu-radio-group v-model="value"></wu-radio-group>
	 */
	export default {
		name: 'wu-radio-group',
		...
		computed: {
			...
			parentData() {
				return [
					this.value, this.modelValue, this.disabled, this.inactiveColor, 
					this.activeColor, this.size, this.labelDisabled, this.shape,
