...
<script>
	 ...
	 * @tutorial https://wu.geeks.ink/zh-CN/components/navbar.html
	 ...
	 * @example <wu-navbar title="剑未配妥，出门已是江湖" left-text="返回" right-text="帮助" @click-left="onClickBack" @click-right="onClickRight"></wu-navbar>
	 */
	export default {
		name: 'wu-navbar',
