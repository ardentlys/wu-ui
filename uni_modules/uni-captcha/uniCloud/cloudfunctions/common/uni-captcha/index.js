...
function k(e, t, n) {
	var o, r, s, a, i, l;
	for (o = O(e, 5, 257), r = O(e, 5, 1), s = O(e, 4, 4), a = 0; a < 19; ++a) S[a] = 0;
	for (a = 0; a < s; ++a) {
		var c = O(e, 3, 0);
		S[v[a]] = c
	}
	for (T(b, S, 0, 19), i = 0; i < o + r;) {
		var u = w(e, b);
		switch (u) {
			case 16:
				var p = S[i - 1];
				for (l = O(e, 2, 3); l; --l) S[i++] = p;
				break;
			case 17:
				for (l = O(e, 3, 3); l; --l) S[i++] = 0;
				break;
			case 18:
				for (l = O(e, 7, 11); l; --l) S[i++] = 0;
				break;
			default:
				S[i++] = u
		}
...
function R(e, t, n) {
	for (;;) {
		...
		if (i < 256) e.dest[e.destLen++] = i;
			...
			for (o = O(e, d[i -= 257], g[i]), r = w(e, n), a = s = e.destLen - O(e, m[r], y[r]); a < s + o; ++a) e.dest[
				e.destLen++] = e.dest[a]
	}
}
...
}(h, f), x(d, g, 4, 3), x(m, y, 2, 1), d[28] = 0, g[28] = 258;
var C = function(e, t) {
	var n, o, r = new p(e, t);
	do {
		switch (n = E(r), O(r, 2, 0)) {
			case 0:
				o = D(r);
				break;
			case 1:
				...
				break;
			case 2:
				k(r, r.ltree, r.dtree), o = R(r, r.ltree, r.dtree);
				break;
			default:
				o = -3
		}
...
I.prototype.isEmpty = function() {
...
}, I.prototype.addPoint = function(e, t) {
...
}, I.prototype.addX = function(e) {
	this.addPoint(e, null)
}, I.prototype.addY = function(e) {
	this.addPoint(null, e)
}, I.prototype.addBezier = function(e, t, n, o, r, s, a, i) {
	const l = [e, t],
		c = [n, o],
		u = [r, s],
		p = [a, i];
	...
	for (let e = 0; e <= 1; e++) {
		...
		if (0 === n) {
			if (0 === t) continue;
			const n = -o / t;
			0 < n && n < 1 && (0 === e && this.addX(L(l[e], c[e], u[e], p[e], n)), 1 === e && this.addY(L(l[e], c[
				e], u[e], p[e], n)));
			continue
		}
		...
		0 < s && s < 1 && (0 === e && this.addX(L(l[e], c[e], u[e], p[e], s)), 1 === e && this.addY(L(l[e], c[e], u[
			e], p[e], s)));
		const a = (-t - Math.sqrt(r)) / (2 * n);
		0 < a && a < 1 && (0 === e && this.addX(L(l[e], c[e], u[e], p[e], a)), 1 === e && this.addY(L(l[e], c[e], u[
			e], p[e], a)))
	}
}, I.prototype.addQuad = function(e, t, n, o, r, s) {
	const a = e + 2 / 3 * (n - e),
		i = t + 2 / 3 * (o - t),
		l = a + 1 / 3 * (r - e),
		c = i + 1 / 3 * (s - t);
...
}, M.prototype.curveTo = M.prototype.bezierCurveTo = function(e, t, n, o, r, s) {
	this.commands.push({
		type: "C",
		x1: e,
		y1: t,
...
}, M.prototype.quadTo = M.prototype.quadraticCurveTo = function(e, t, n, o) {
	this.commands.push({
		type: "Q",
		x1: e,
		y1: t,
...
}, M.prototype.close = M.prototype.closePath = function() {
	this.commands.push({
		type: "Z"
	})
...
A.BYTE = function(e) {
	...
	.UFWORD = F.USHORT, A.LONGDATETIME = function(e) {
		...
		return N.argument(4 === e.length, "Tag should be exactly 4 ASCII characters."), [e.charCodeAt(0), e.charCodeAt(
...
const _ = "function" == typeof WeakMap && new WeakMap;
let W;
...
A.MACSTRING = function(e, t) {
	const n = function(e) {
		if (!W) {
			W = {};
			for (let e in z) W[e] = new String(e)
		}
		const t = W[e];
		if (void 0 === t) return;
		if (_) {
	...
	let n = [];
	if (Array.isArray(t))
		for (let o = 0; o < t.length; o += 1) N.argument(e.length === t.length,
...
function J(e) {
	1 === e.format ? Z.call(this, "coverageTable", [{
		...
		type: "USHORT",
		value: 1
	}].concat(Q("glyph", e.glyphs))) : N.assert(!1, "Can't create coverage table format 2 yet.")
}
...
function ee(e) {
	Z.call(this, "scriptListTable", K("scriptRecord", e, (function(e, t) {
		...
		return N.assert(!!o, "Unable to write GSUB: script " + e.tag +
			...
			value: new Z("scriptTable", [{
				...
				}].concat(Q("featureIndex", o.featureIndexes)))
...
function te(e) {
	Z.call(this, "featureListTable", K("featureRecord", e, (function(e, t) {
		...
		return [{
			...
			}].concat(Q("lookupListIndex", n.lookupListIndexes)))
		}]
	})))
}

function ne(e, t) {
	Z.call(this, "lookupListTable", $("lookup", e, (function(e) {
		let n = t[e.lookupType];
		return N.assert(!!n, "Unable to write GSUB lookup type " + e.lookupType + " tables."), new Z(
			"lookupTable", [{
				name: "lookupType",
				type: "USHORT",
				value: e.lookupType
...
A.CHARSTRING = function(e) {
		...
		for (let s = 0; s < n; s += 1) {
			const n = e.fields[s],
				a = A[n.type];
			N.argument(void 0 !== a, "No encoding function for field type " + n.type + " (" + n.name + ")");
			let i = e[n.name];
			void 0 === i && (i = n.value);
			const l = a(i);
		...
		for (let n = 0; n < o.length; n += 1) {
			const s = r[n],
				a = t.length;
			N.argument(a < 65536, "Table " + e.tableName + " too big."), t[s] = a >> 8, t[s + 1] = 255 & a, t = t
				.concat(o[n])
		}
		return t
	}, F.TABLE = function(e) {
		...
		for (let o = 0; o < n; o += 1) {
			const n = e.fields[o],
				r = F[n.type];
			N.argument(void 0 !== r, "No sizeOf function for field type " + n.type + " (" + n.name + ")");
			let s = e[n.name];
...
ce.prototype.parseScriptList = function() {
	...
	return this.parsePointer(ce.list(ce.pointer((function() {
		...
		N.argument(1 <= t && t <= 8, "GSUB lookup type " + t + " unknown.");
...
var fe = {
	parse: function(e, t) {
		const n = {};
		n.version = pe.getUShort(e, t), N.argument(0 === n.version, "cmap table version should be 0."), n
...
}, Se.prototype.charToGlyphIndex = function(e) {
	const t = e.charCodeAt(0),
		n = this.encoding[t];
	return this.charset.indexOf(n)
}, xe.prototype.nameToGlyphIndex = function(e) {
	return this.names.indexOf(e)
}, xe.prototype.glyphIndexToName = function(e) {
	return this.names[e]
};
var Ue = {
...
function Ee(e, t, n) {
	...
	if (e.numberOfContours = o.parseShort(), e._xMin = o.parseShort(), e._yMin = o.parseShort(), e._xMax = o
		...
		for (let e = 0; e < n; e += 1)
			...
			} if (N.argument(r.length === n, "Bad flags."), t.length > 0) {
			const a = [];
			let i;
			if (n > 0) {
...
function we(e) {
	...
	const n = function(e) {
		...
		return N.argument(0 === n.length, "There are still points left in the current contour."), t
	}(e);
	...
	if (t.isComposite)
		for (let n = 0; n < t.components.length; n += 1) {
			...
			if (r.getPath(), r.points) {
				let e;
				if (void 0 === o.matchedPoints) e = Oe(r.points, o);
				else {
					...
					s = Oe([s], a)[0], a.dx = n.x - s.x, a.dy = n.y - s.y, e = Oe(r.points, a)
				}
...
var Re = {
	...
	parse: function(e, t, n, o) {
		const r = new Ie.GlyphSet(o);
		for (let s = 0; s < n.length - 1; s += 1) {
			const a = n[s];
			a !== n[s + 1] ? r.push(s, Ie.ttfGlyphLoader(o, s, Ee, e, t + a, ke)) : r.push(s, Ie.glyphLoader(o,
				s))
		}
		return r
	}
...
De.prototype.bindConstructorValues = function(e) {
...
}, De.prototype.addUnicode = function(e) {
	0 === this.unicodes.length && (this.unicode = e), this.unicodes.push(e)
}, De.prototype.getBoundingBox = function() {
	return this.path.getBoundingBox()
}, De.prototype.getPath = function(e, t, n, o, r) {
	let s, a;
	e = void 0 !== e ? e : 0, t = void 0 !== t ? t : 0, n = void 0 !== n ? n : 72, o || (o = {});
	let i = o.xScale,
		l = o.yScale;
	if (o.hinting && r && r.hinting && (a = this.path && r.hinting.exec(this, n)), a) s = Re.getPath(a).commands,
...
}, De.prototype.draw = function(e, t, n, o, r) {
	this.getPath(t, n, o, r).draw(e)
}, De.prototype.drawPoints = function(e, t, n, o) {
	function r(t, n, o, r) {
		const s = 2 * Math.PI;
		e.beginPath();
...
}, De.prototype.drawMetrics = function(e, t, n, o) {
	let r;
...
var Ie = {
	...
	ttfGlyphLoader: function(e, t, n, o, r, s) {
		return function() {
			...
			}, Ce(a, "xMin", "_xMin"), Ce(a, "xMax", "_xMax"), Ce(a, "yMin", "_yMin"), Ce(a, "yMax",
				"_yMax"), a
		}
	},
...
function Pe(e, t, n) {
	...
	for (n = void 0 !== n ? n : e.length; o.relativeOffset < n;) {
		let e = o.parseByte();
		e <= 21 ? (12 === e && (e = 1200 + o.parseByte()), r.push([e, s]), s = []) : s.push(Ne(o, e))
	}
	return function(e) {
		const t = {};
		for (let n = 0; n < e.length; n += 1) {
...
function qe(e, t, n, o) {
	...
	for (let s = 0; s < n.length; s += 1) {
		const a = _e(new DataView(new Uint8Array(n[s]).buffer), o);
...
function Xe(e, t, n) {
	...
	return function n(p) {
		let x, U, T, E, O, w, k, R, D, C, L, I, M = 0;
		for (; M < p.length;) {
			let B = p[M];
			switch (M += 1, B) {
				case 1:
				...
				case 12:
					switch (B = p[M], M += 1, B) {
						case 35:
							o = m + l.shift(), r = y + l.shift(), s = o + l.shift(), a = r + l.shift(), k = s + l
								.shift(), R = a + l.shift(), D = k + l.shift(), C = R + l.shift(), L = D + l
							.shift(), I = C + l.shift(), m = L + l.shift(), y = I + l.shift(), l.shift(), i.curveTo(
									o, r, s, a, k, R), i.curveTo(D, C, L, I, m, y);
							break;
						case 34:
							o = m + l.shift(), r = y, s = o + l.shift(), a = r + l.shift(), k = s + l.shift(), R =
								a, D = k + l.shift(), C = a, L = D + l.shift(), I = y, m = L + l.shift(), i.curveTo(
									o, r, s, a, k, R), i.curveTo(D, C, L, I, m, y);
							break;
						case 36:
							o = m + l.shift(), r = y + l.shift(), s = o + l.shift(), a = r + l.shift(), k = s + l
								.shift(), R = a, D = k + l.shift(), C = a, L = D + l.shift(), I = C + l.shift(), m =
								L + l.shift(), i.curveTo(o, r, s, a, k, R), i.curveTo(D, C, L, I, m, y);
							break;
						case 37:
							o = m + l.shift(), r = y + l.shift(), s = o + l.shift(), a = r + l.shift(), k = s + l
								.shift(), R = a + l.shift(), D = k + l.shift(), C = R + l.shift(), L = D + l
							.shift(), I = C + l.shift(), Math.abs(L - m) > Math.abs(I - y) ? m = L + l.shift() : y =
								I + l.shift(), i.curveTo(o, r, s, a, k, R), i.curveTo(D, C, L, I, m, y);
							break;
						default:
				...
				case 27:
					...
					break;
				case 28:
					x = p[M], U = p[M + 1], l.push((x << 24 | U << 16) >> 16), M += 2;
					break;
				case 29:
				...
				default:
					B < 32 ? console.log("Glyph " + t.index + ": unknown operator " + B) : B < 247 ? l.push(B -
						139) : B < 251 ? (x = p[M], M += 1, l.push(256 * (B - 247) + x + 108)) : B < 255 ? (x = p[
							M], M += 1, l.push(256 * -(B - 251) - x - 108)) : (x = p[M], U = p[M + 1], T = p[M + 2],
							E = p[M + 3], M += 4, l.push((x << 24 | U << 16 | T << 8 | E) / 65536))
			}
		}
...
function je(e, t, n) {
	...
	for (let r = 0; r < e.length; r += 1) {
		const s = e[r];
		let a = t[s.name];
		void 0 === a || Me(a, s.value) || ("SID" === s.type && (a = Ve(a, n)), o[s.op] = {
			name: s.name,
			type: s.type,
			value: a
		})
...
var $e = {
	parse: function(e, t, n) {
		...
		const o = Ge(e, function(e, t) {
			...
			r = Ge(e, o.endOffset),
			s = Ge(e, r.endOffset, pe.bytesToString),
			a = Ge(e, s.endOffset);
		...
		if (n.tables.cff.topDict = l, l._privateDict && (n.defaultWidthX = l._privateDict.defaultWidthX, n
			...
			o += t;
			const a = qe(e, t, Ge(e, o).objects, s.objects);
		...
		0 === l.encoding ? n.cffEncoding = new Se(ge, h) : 1 === l.encoding ? n.cffEncoding = new Se(me, h) : n
			.cffEncoding = function(e, t, n) {
				...
				return new Se(r, n)
			}(e, t + l.encoding, h), n.encoding = n.encoding || n.cffEncoding, n.glyphs = new Ie.GlyphSet(n);
		for (let e = 0; e < n.nGlyphs; e += 1) {
			const t = p.objects[e];
			n.glyphs.push(e, Ie.cffGlyphLoader(n, e, Xe, t))
		}
	},
	make: function(e, t) {
...
var Ke = {
	parse: function(e, t) {
		...
		return n.version = o.parseVersion(), n.fontRevision = Math.round(1e3 * o.parseFixed()) / 1e3, n
			.checkSumAdjustment = o.parseULong(), n.magicNumber = o.parseULong(), N.argument(1594834165 === n
...
var tt = {
	...
	parse: function(e, t) {
		const n = new pe.Parser(e, t),
			o = n.parseULong();
		N.argument(1 === o, "Unsupported ltag table version."), n.skip("uLong", 1);
...
St[1] = function(e) {
	...
	return N.assert(1 === e.substFormat, "Lookup type 3 substFormat must be 1."), new oe.Table("substitutionTable",
		[{
			name: "substFormat",
			type: "USHORT",
			value: 1
	...
	return N.assert(1 === e.substFormat, "Lookup type 4 substFormat must be 1."), new oe.Table("substitutionTable",
		[{
			name: "substFormat",
			type: "USHORT",
			value: 1
...
var xt = {
	parse: function(e, t) {
		const n = new ce(e, t = t || 0),
			o = n.parseVersion();
		return N.argument(1 === o, "Unsupported GSUB table version."), {
			version: o,
	...
	make: function(e) {
		return new oe.Table("GSUB", [{
			...
			name: "lookups",
			type: "TABLE",
			value: new oe.LookupList(e.lookups, St)
		}])
	}
};
var Ut = {
	parse: function(e, t) {
		const n = new pe.Parser(e, t),
			o = n.parseULong();
		N.argument(1 === o, "Unsupported META table version."), n.parseULong(), n.parseULong();
		const r = n.parseULong(),
			s = {};
		for (let o = 0; o < r; o++) {
			const o = n.parseTag(),
...
function wt(e) {
	...
	const o = [],
		r = [];
	let s = t.sizeOf() + Ot().sizeOf() * t.numTables;
	...
	for (let t = 0; t < e.length; t += 1) {
		const n = e[t];
		N.argument(4 === n.tableName.length, "Table name" + n.tableName + " is invalid.");
		const a = n.sizeOf(),
			i = Ot(n.tableName, Et(n.encode()), s, a);
		for (o.push({
				...
				type: "RECORD",
				value: n
			}), s += a, N.argument(!isNaN(s), "Something went wrong calculating the offset."); s % 4 != 0;) s += 1, r
			.push({
				name: "padding",
				type: "BYTE",
				value: 0
	...
	fontToTable: function(e) {
		...
		const g = Ke.make({
			...
			v = mt.make({
				...
				sCapHeight: kt(e, "HIKLEFJMNTZBDPRAGOQSUVWXY", d).yMax,
		...
		O.uniqueID || (O.uniqueID = {
			...
			en: E
		}), O.preferredFamily || (O.preferredFamily = e.names.fontFamily), O.preferredSubfamily || (O
			.preferredSubfamily = e.names.fontSubfamily);
		const w = [],
			k = dt.make(O, w),
			R = w.length > 0 ? tt.make(w) : void 0,
			D = yt.make(),
			C = $e.make(e.glyphs, {
			...
			L = e.metas && Object.keys(e.metas).length > 0 ? Ut.make(e.metas) : void 0,
			I = [g, m, y, v, k, S, D, C, b];
		R && I.push(R), e.tables.gsub && I.push(xt.make(e.tables.gsub)), L && I.push(L);
		const M = wt(I),
			B = Et(M.encode()),
			G = M.fields;
		let N = !1;
...
Lt.prototype = {
	...
	getFeatureTable: function(e, t, n, o) {
		...
		if (r) {
			...
			if (o) {
				const o = s.length;
				return N.assert(0 === o || n >= s[o - 1].tag, "Features must be added in alphabetical order."),
					e = {
						tag: n,
						feature: {
							params: 0,
...
}, It.prototype = Lt.prototype, It.prototype.createDefaultTable = function() {
	return {
		version: 1,
		scripts: [{
			tag: "DFLT",
...
}, It.prototype.getSingle = function(e, t, n) {
	const o = [],
	...
	return o
}, It.prototype.getAlternates = function(e, t, n) {
	const o = [],
	...
	return o
}, It.prototype.getLigatures = function(e, t, n) {
	const o = [],
	...
	return o
}, It.prototype.addSingle = function(e, t, n, o) {
	...
	N.assert(1 === r.coverage.format, "Ligature: unable to modify coverage table format " + r.coverage.format);
	const s = t.sub;
...
}, It.prototype.addAlternate = function(e, t, n, o) {
	...
	a < 0 && (a = -1 - a, r.coverage.glyphs.splice(a, 0, s), r.alternateSets.splice(a, 0, 0)), r.alternateSets[a] =
		t.by
}, It.prototype.addLigature = function(e, t, n, o) {
	...
	s || (s = {
		...
		ligatureSets: []
	}, r.subtables[0] = s), N.assert(1 === s.coverage.format,
...
}, It.prototype.add = function(e, t, n, o) {
		...
		interpolate: function(e, t, n, o) {
			...
			if (!o || o === this) return r = e.yo - t.yo, s = e.yo - n.yo, l = t.y - t.yo, c = n.y - n.yo, a = Math
				.abs(r), i = Math.abs(s), u = a + i, 0 === u ? void(e.y = e.yo + (l + c) / 2) : void(e.y = e
					.yo + (l * i + c * a) / u);
			r = o.distance(e, t, !0, !0), s = o.distance(e, n, !0, !0), l = o.distance(t, t, !1, !0), c = o
				.distance(n, n, !1, !0), a = Math.abs(r), i = Math.abs(s), u = a + i, 0 !== u ? Qt.setRelative(e, e,
					(l * i + c * a) / u, o, !0) : Qt.setRelative(e, e, (l + c) / 2, o, !0)
		},
		normalSlope: 0,
		setRelative: function(e, t, n, o, r) {
...
function Kt(e, t) {
	...
	return t /= n, 1 === (e /= n) && 0 === t ? Zt : 0 === e && 1 === t ? Qt : new $t(e, t)
}
...
Object.freeze(Zt), Object.freeze(Qt), $t.prototype.distance = function(e, t, n, o) {
	return this.x * Zt.distance(e, t, n, o) + this.y * Qt.distance(e, t, n, o)
}, $t.prototype.interpolate = function(e, t, n, o) {
	let r, s, a, i, l, c, u;
...
}, $t.prototype.setRelative = function(e, t, n, o, r) {
	o = o || this;
	const s = r ? t.xo : t.x,
		a = r ? t.yo : t.y,
		i = s + n * o.x,
...
function nn(e, t) {
	switch (this.env = e, this.stack = [], this.prog = t, e) {
		...
		case "prep":
			this.fv = this.pv = this.dpv = Zt, this.round = Wt
	}
}
...
function Rn(e) {
	(e = e || {}).empty || (Nt(e.familyName, "When creating a new Font object, familyName is required."), Nt(e
				.styleName, "When creating a new Font object, styleName is required."), Nt(e.unitsPerEm,
				"When creating a new Font object, unitsPerEm is required."), Nt(e.ascender,
				"When creating a new Font object, ascender is required."), Nt(e.descender,
				"When creating a new Font object, descender is required."), Nt(e.descender < 0,
			...
			}), this.supported = !0, this.glyphs = new Ie.GlyphSet(this, e.glyphs || []), this.encoding = new ve(this),
		this.substitution = new It(this), this.tables = this.tables || {}, Object.defineProperty(this, "hinting", {
			get: function() {
...
zt.prototype.exec = function(e, t) {
...
}, Pt = [sn.bind(void 0, Qt), sn.bind(void 0, Zt), an.bind(void 0, Qt), an.bind(void 0, Zt), ln.bind(void 0, Qt), ln
	...
	void 0, hn.bind(void 0, 0), hn.bind(void 0, 1), fn.bind(void 0, Qt), fn.bind(void 0, Zt), dn.bind(void 0, 0), dn
	...
	bn.bind(void 0, 0), bn.bind(void 0, 1), void 0, Sn.bind(void 0, 0), Sn.bind(void 0, 1),
	function(e) {
	...
	xn.bind(void 0, 2), xn.bind(void 0, 3), Tn.bind(void 0, 1), Tn.bind(void 0, 2), Tn.bind(void 0, 3),
	function(e) {
		let t, n = e.stack.pop();
	...
	En.bind(void 0, 0), En.bind(void 0, 1),
	function(e) {
		const t = e.stack,
			n = t.pop();
		let o = 0;
	...
	void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0,
	void 0, void 0, void 0, void 0, void 0, On.bind(void 0, 1), On.bind(void 0, 2), On.bind(void 0, 3), On.bind(
		void 0, 4), On.bind(void 0, 5), On.bind(void 0, 6), On.bind(void 0, 7), On.bind(void 0, 8), wn.bind(void 0,
		1), wn.bind(void 0, 2), wn.bind(void 0, 3), wn.bind(void 0, 4), wn.bind(void 0, 5), wn.bind(void 0, 6), wn
	.bind(void 0, 7), wn.bind(void 0, 8), kn.bind(void 0, 0, 0, 0, 0, 0), kn.bind(void 0, 0, 0, 0, 0, 1), kn.bind(
		void 0, 0, 0, 0, 0, 2), kn.bind(void 0, 0, 0, 0, 0, 3), kn.bind(void 0, 0, 0, 0, 1, 0), kn.bind(void 0, 0,
		0, 0, 1, 1), kn.bind(void 0, 0, 0, 0, 1, 2), kn.bind(void 0, 0, 0, 0, 1, 3), kn.bind(void 0, 0, 0, 1, 0, 0),
	kn.bind(void 0, 0, 0, 1, 0, 1), kn.bind(void 0, 0, 0, 1, 0, 2), kn.bind(void 0, 0, 0, 1, 0, 3), kn.bind(void 0,
		0, 0, 1, 1, 0), kn.bind(void 0, 0, 0, 1, 1, 1), kn.bind(void 0, 0, 0, 1, 1, 2), kn.bind(void 0, 0, 0, 1, 1,
		3), kn.bind(void 0, 0, 1, 0, 0, 0), kn.bind(void 0, 0, 1, 0, 0, 1), kn.bind(void 0, 0, 1, 0, 0, 2), kn.bind(
		void 0, 0, 1, 0, 0, 3), kn.bind(void 0, 0, 1, 0, 1, 0), kn.bind(void 0, 0, 1, 0, 1, 1), kn.bind(void 0, 0,
		1, 0, 1, 2), kn.bind(void 0, 0, 1, 0, 1, 3), kn.bind(void 0, 0, 1, 1, 0, 0), kn.bind(void 0, 0, 1, 1, 0, 1),
	kn.bind(void 0, 0, 1, 1, 0, 2), kn.bind(void 0, 0, 1, 1, 0, 3), kn.bind(void 0, 0, 1, 1, 1, 0), kn.bind(void 0,
		0, 1, 1, 1, 1), kn.bind(void 0, 0, 1, 1, 1, 2), kn.bind(void 0, 0, 1, 1, 1, 3), kn.bind(void 0, 1, 0, 0, 0,
		0), kn.bind(void 0, 1, 0, 0, 0, 1), kn.bind(void 0, 1, 0, 0, 0, 2), kn.bind(void 0, 1, 0, 0, 0, 3), kn.bind(
		void 0, 1, 0, 0, 1, 0), kn.bind(void 0, 1, 0, 0, 1, 1), kn.bind(void 0, 1, 0, 0, 1, 2), kn.bind(void 0, 1,
		0, 0, 1, 3), kn.bind(void 0, 1, 0, 1, 0, 0), kn.bind(void 0, 1, 0, 1, 0, 1), kn.bind(void 0, 1, 0, 1, 0, 2),
	kn.bind(void 0, 1, 0, 1, 0, 3), kn.bind(void 0, 1, 0, 1, 1, 0), kn.bind(void 0, 1, 0, 1, 1, 1), kn.bind(void 0,
		1, 0, 1, 1, 2), kn.bind(void 0, 1, 0, 1, 1, 3), kn.bind(void 0, 1, 1, 0, 0, 0), kn.bind(void 0, 1, 1, 0, 0,
		1), kn.bind(void 0, 1, 1, 0, 0, 2), kn.bind(void 0, 1, 1, 0, 0, 3), kn.bind(void 0, 1, 1, 0, 1, 0), kn.bind(
		void 0, 1, 1, 0, 1, 1), kn.bind(void 0, 1, 1, 0, 1, 2), kn.bind(void 0, 1, 1, 0, 1, 3), kn.bind(void 0, 1,
		1, 1, 0, 0), kn.bind(void 0, 1, 1, 1, 0, 1), kn.bind(void 0, 1, 1, 1, 0, 2), kn.bind(void 0, 1, 1, 1, 0, 3),
	kn.bind(void 0, 1, 1, 1, 1, 0), kn.bind(void 0, 1, 1, 1, 1, 1), kn.bind(void 0, 1, 1, 1, 1, 2), kn.bind(void 0,
		1, 1, 1, 1, 3)
], Rn.prototype.hasChar = function(e) {
	...
	return t
}, Rn.prototype.getPath = function(e, t, n, o, r) {
	const s = new M;
	return this.forEachGlyph(e, t, n, o, r, (function(e, t, n, o) {
		const a = e.getPath(t, n, o, r, this);
		s.extend(a)
	})), s
}, Rn.prototype.getPaths = function(e, t, n, o, r) {
	const s = [];
	return this.forEachGlyph(e, t, n, o, r, (function(e, t, n, o) {
		const a = e.getPath(t, n, o, r, this);
		s.push(a)
	})), s
}, Rn.prototype.getAdvanceWidth = function(e, t, n) {
	return this.forEachGlyph(e, 0, 0, t, n, (function() {}))
}, Rn.prototype.draw = function(e, t, n, o, r, s) {
	this.getPath(t, n, o, r, s).draw(e)
}, Rn.prototype.drawPoints = function(e, t, n, o, r, s) {
	this.forEachGlyph(t, n, o, r, s, (function(t, n, o, r) {
		t.drawPoints(e, n, o, r)
	}))
}, Rn.prototype.drawMetrics = function(e, t, n, o, r, s) {
	this.forEachGlyph(t, n, o, r, s, (function(t, n, o, r) {
		t.drawMetrics(e, n, o, r)
	}))
}, Rn.prototype.getEnglishName = function(e) {
...
}, Rn.prototype.toTables = function() {
	return Dt.fontToTable(this)
}, Rn.prototype.toBuffer = function() {
	...
	for (let t = 0; t < e.length; t++) n[t] = e[t];
	return t
}, Rn.prototype.download = function(e) {
...
}, Rn.prototype.fsSelectionValues = {
	ITALIC: 1,
	UNDERSCORE: 2,
	NEGATIVE: 4,
	OUTLINED: 8,
...
var Bn = {
	make: function(e, t) {
		...
		for (let o = 0; o < e.axes.length; o++) n.fields = n.fields.concat(Cn(o, e.axes[o], t));
		for (let o = 0; o < e.instances.length; o++) n.fields = n.fields.concat(In(o, e.instances[o], e.axes,
			t));
		return n
	},
	parse: function(e, t, n) {
		const o = new pe.Parser(e, t),
			r = o.parseULong();
		N.argument(65536 === r, "Unsupported fvar table version.");
		...
		const a = o.parseUShort(),
			...
			c = o.parseUShort(),
			u = [];
		for (let o = 0; o < a; o++) u.push(Ln(e, t + s + o * i, n));
		const p = [],
			h = t + s + a * i;
...
var Fn = {
	parse: function(e, t, n) {
		const o = new pe.Parser(e, t),
			r = o.parseFixed();
		N.argument(1 === r, "Unsupported GPOS table version."), Gn(e, t + o.parseUShort()), Gn(e, t + o
			.parseUShort());
...
var Hn = {
	parse: function(e, t) {
		...
		if (0 === o) return function(e) {
			...
			N.argument(0 === n, "Unsupported kern sub-table version."), e.skip("uShort", 2);
...
function Xn(e, t) {
	if ("WOFF" === t.compression) {
		...
		if (C(n, o), o.byteLength !== t.length) throw new Error("Decompression error: " + t.tag +
...
function Vn(e) {
	...
	for (let e = 0; e < s; e += 1) {
		...
		switch (s.tag) {
			...
			case "OS/2":
				...
				break;
			case "post":
				i = Xn(r, s), o.tables.post = yt.parse(i.data, i.offset), o.glyphNames = new xe(o.tables.post);
				break;
			case "prep":
	...
	if (o.tables.name = dt.parse(b.data, b.offset, n), o.names = o.tables.name, u && g) {
		const e = 0 === t,
			...
			a = Xn(r, u);
		o.glyphs = Re.parse(a.data, a.offset, s, o)
	} else {
		if (!l) throw new Error("Font doesn't contain TrueType or CFF outlines."); {
			const e = Xn(r, l);
			$e.parse(e.data, e.offset, o)
		}
	}
	const S = Xn(r, f);
	if (et.parse(S.data, S.offset, o.numberOfHMetrics, o.numGlyphs, o.glyphs), function(e) {
			let t;
	...
	if (h) {
		const e = Xn(r, h);
		o.tables.gsub = xt.parse(e.data, e.offset)
	}
	if (c) {
		const e = Xn(r, c);
...
var jn = Object.freeze({
	...
	parse: Vn,
	load: function(e, t) {
		("undefined" == typeof window ? _n : Wn)(e, (function(e, n) {
			if (e) return t(e);
			let o;
			try {
				o = Vn(n)
	...
	loadSync: function(e) {
		return Vn(Gt(require("fs").readFileSync(e)))
	}
});
...
var $n = {
	...
	loadFont: e => {
		...
		Qn.font = t, Qn.ascender = t.ascender, Qn.descender = t.descender
	}
};
const Kn = $n.options,
	Jn = function(e, t) {
...
function go(e) {
	return "[object Object]" === fo.call(e)
}
...
function vo(e) {
	return yo.constructor === e.constructor ? async function() {
		const t = await e.apply(this, arguments);
		return go(t) && (t.msg && (t.message = t.msg, t.errMsg = t.msg), 0 === t.code ? t.errCode = t.code : t
...
const bo = uniCloud.database(),
	So = bo.collection("opendb-verify-codes");
class xo {
	async setVerifyCode({
		clientIP: e,
		deviceId: t,
		...
		return mo("addRes", await So.add(a)), {
			code: 0,
			deviceId: t
		}
	}
	async verifyCode({
		...
		const o = Date.now(),
			...
			s = await So.where(r).orderBy("created_date", "desc").limit(1).get();
		if (mo("verifyRecord:", s), s && s.data && s.data.length > 0) {
			const e = s.data[0];
			if (e.expired_date < o) return {
				code: 10103,
				msg: "验证码已失效"
			};
			return mo("upRes", await So.doc(e._id).update({
				state: 1
			})), {
				code: 0,
				msg: "验证通过"
...
class To extends class {
	...
	_initConfig() {
		...
		if (e && e.hasFile("config.json")) try {
			const t = e.config();
			go(t) && (this.pluginConfig = t)
		} catch (e) {
			throw new Error(this.t("config-file-invalid") + "\n" + e.messages)
		}
	}
	_initScene() {
		if (go(this.pluginConfig.scene)) {
			const {
				scene: e,
				...t
			} = this.pluginConfig;
	...
	mergeConfig(e) {
		const t = go(this.pluginConfig.scene) ? this.pluginConfig.scene[e.scene] : e.scene;
		return Object.assign({}, go(t) ? t : this.pluginConfig, e)
	}
	async create(e = {}) {
	...
	async refresh(e = {}) {
		...
		const s = await So.where(bo.command.or([{
			device_uuid: o,
			scene: t
		}, {
			deviceId: o,
...
Object.keys(Eo).forEach(e => {
	To.prototype[e] = vo(Eo[e])
});
const Oo = new To,
	wo = new Proxy(Oo, {
		get(e, t) {
			if (t in e) return "function" == typeof e[t] ? vo(e[t]).bind(wo) : e[t]
		}
	});
module.exports = wo;