...
(() => {
  ...
  if (webview) {
    ...
    const __pagePath = "pages/componentsA/cell/cell";
    let __pageQuery = {};
    try {
    ...
    cell.mpType = "page";
    const app = Vue.createPageApp(cell, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...cell.styles || []]));
    app.mount("#root");
  }
})();
