...
(() => {
  ...
  // ../../../Documents/HBuilderProjects/wu-ui/unpackage/dist/dev/.nvue/pages/componentsA/transition/transition.js
  var import_vue5 = __toESM(require_vue());
  var _style_04 = { "wu-page": { "": { "paddingTop": 0, "paddingRight": 0, "paddingBottom": 0, "paddingLeft": 0 } }, "transition": { "": { "backgroundColor": "#3c9cff" } } };
  var _sfc_main4 = {
    data() {
      return {
        mode: "",
  ...
  function _sfc_render4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_u_transition = (0, import_vue5.resolveComponent)("u-transition");
    ...
    return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("scroll-view", {
      ...
      (0, import_vue5.createElementVNode)("view", { class: "wu-page" }, [
        ...
        (0, import_vue5.createVNode)(_component_wu_cell_group, { border: "" }, {
          default: (0, import_vue5.withCtx)(() => [
            ...
            (0, import_vue5.createVNode)(_component_u_transition, {
              mode: $data.mode,
              show: $data.show,
              ...
              default: (0, import_vue5.withCtx)(() => [
                (0, import_vue5.createElementVNode)("view", { class: "transition" })
              ]),
              _: 1
              /* STABLE */
  ...
  var transition = /* @__PURE__ */ _export_sfc(_sfc_main4, [["render", _sfc_render4], ["styles", [_style_04]], ["__file", "C:/Users/13179/Documents/HBuilderProjects/wu-ui/pages/componentsA/transition/transition.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/componentsA/transition/transition";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    transition.mpType = "page";
    const app = Vue.createPageApp(transition, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...transition.styles || []]));
    app.mount("#root");
  }
})();
