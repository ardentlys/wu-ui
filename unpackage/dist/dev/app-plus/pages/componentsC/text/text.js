...
(() => {
  ...
  function addUnit(value2 = "auto", unit = ((_b3) => (_b3 = ((_a3) => (_a3 = uni == null ? void 0 : uni.$w) == null ? void 0 : _a3.config)()) == null ? void 0 : _b3.unit)() ? ((_d2) => (_d2 = ((_c2) => (_c2 = uni == null ? void 0 : uni.$w) == null ? void 0 : _c2.config)()) == null ? void 0 : _d2.unit)() : "px") {
    ...
    computed: {
      ...
      value() {
        ...
        if (mode === "price") {
          ...
          return this.$w.priceFormat(text2, 2);
        }
        if (mode === "date") {
          !this.$w.test.date(text2) && this.$w.error("\u65E5\u671F\u6A21\u5F0F\u4E0B\uFF0Ctext\u53C2\u6570\u9700\u8981\u4E3A\u65E5\u671F\u6216\u65F6\u95F4\u6233\u683C\u5F0F");
          if (this.$w.test.func(format)) {
            return format(text2);
          }
          if (format) {
            return this.$w.timeFormat(text2, format);
          }
          return this.$w.timeFormat(text2, "yyyy-mm-dd");
        }
        if (mode === "phone") {
          if (this.$w.test.func(format)) {
            return format(text2);
        ...
        if (mode === "name") {
          !(typeof text2 === "string") && this.$w.error("\u59D3\u540D\u6A21\u5F0F\u4E0B\uFF0Ctext\u53C2\u6570\u9700\u8981\u4E3A\u5B57\u7B26\u4E32\u683C\u5F0F");
          if (this.$w.test.func(format)) {
            return format(text2);
          }
          if (format === "encrypt") {
  ...
  // ../../../Documents/HBuilderProjects/wu-ui/unpackage/dist/dev/.nvue/pages/componentsC/text/text.js
  var import_vue4 = __toESM(require_vue());
  var _style_03 = { "wu-page__text-item": { "": { "marginRight": 10, "flex": 1 } }, "wu-demo-block__content": { "": { "flexDirection": "row", "flexWrap": "wrap", "alignItems": "center" } } };
  var _sfc_main3 = {
    onLoad() {
    },
    methods: {
  ...
  function _sfc_render3(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_wu_text = resolveEasycom((0, import_vue4.resolveDynamicComponent)("wu-text"), __easycom_1);
    return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("scroll-view", {
      ...
      (0, import_vue4.createElementVNode)("view", { class: "wu-page" }, [
        (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block" }, [
          (0, import_vue4.createElementVNode)("u-text", { class: "wu-demo-block__title" }, "\u57FA\u7840\u529F\u80FD"),
          (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block__content" }, [
            (0, import_vue4.createElementVNode)("view", { class: "wu-page__text-item" }, [
              (0, import_vue4.createVNode)(_component_wu_text, { text: "\u5927\u9E4F\u4E00\u65E5\u540C\u98CE\u8D77\uFF0C\u6276\u6447\u76F4\u4E0A\u4E5D\u4E07\u91CC" })
            ])
          ])
        ]),
        (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block" }, [
          (0, import_vue4.createElementVNode)("u-text", { class: "wu-demo-block__title" }, "\u8BBE\u7F6E\u4E3B\u9898"),
          (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block__content" }, [
            (0, import_vue4.createElementVNode)("view", { class: "wu-page__text-item" }, [
              (0, import_vue4.createVNode)(_component_wu_text, {
                text: "\u4E3B\u8272",
                type: "primary"
              })
            ]),
        ...
        (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block" }, [
          (0, import_vue4.createElementVNode)("u-text", { class: "wu-demo-block__title" }, "\u62E8\u6253\u7535\u8BDD"),
          (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block__content" }, [
            (0, import_vue4.createElementVNode)("view", { class: "wu-page__text-item" }, [
              (0, import_vue4.createVNode)(_component_wu_text, {
                mode: "phone",
        ...
        (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block" }, [
          (0, import_vue4.createElementVNode)("u-text", { class: "wu-demo-block__title" }, "\u65E5\u671F\u683C\u5F0F\u5316"),
          (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block__content" }, [
            (0, import_vue4.createElementVNode)("view", { class: "wu-page__text-item" }, [
              (0, import_vue4.createVNode)(_component_wu_text, {
                mode: "date",
        ...
        (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block" }, [
          (0, import_vue4.createElementVNode)("u-text", { class: "wu-demo-block__title" }, "\u59D3\u540D\u8131\u654F"),
          (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block__content" }, [
            (0, import_vue4.createElementVNode)("view", { class: "wu-page__text-item" }, [
              (0, import_vue4.createVNode)(_component_wu_text, {
                mode: "name",
        ...
        (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block" }, [
          (0, import_vue4.createElementVNode)("u-text", { class: "wu-demo-block__title" }, "\u8D85\u94FE\u63A5"),
          (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block__content" }, [
            (0, import_vue4.createElementVNode)("view", { class: "wu-page__text-item" }, [
              (0, import_vue4.createVNode)(_component_wu_text, {
                mode: "link",
        ...
        (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block" }, [
          (0, import_vue4.createElementVNode)("u-text", { class: "wu-demo-block__title" }, "\u663E\u793A\u91D1\u989D"),
          (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block__content" }, [
            (0, import_vue4.createElementVNode)("view", { class: "wu-page__text-item" }, [
              (0, import_vue4.createVNode)(_component_wu_text, {
                mode: "price",
        ...
        (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block" }, [
          (0, import_vue4.createElementVNode)("u-text", { class: "wu-demo-block__title" }, "\u524D\u540E\u56FE\u6807"),
          (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block__content" }, [
        ...
        (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block" }, [
          (0, import_vue4.createElementVNode)("u-text", { class: "wu-demo-block__title" }, "\u8D85\u51FA\u9690\u85CF"),
          (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block__content" }, [
            (0, import_vue4.createVNode)(_component_wu_text, {
              lines: 2,
        ...
        (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block" }, [
          (0, import_vue4.createElementVNode)("u-text", { class: "wu-demo-block__title" }, "\u5C0F\u7A0B\u5E8F\u5F00\u653E\u80FD\u529B"),
          (0, import_vue4.createElementVNode)("view", { class: "wu-demo-block__content" }, [
            (0, import_vue4.createVNode)(_component_wu_text, {
              text: "\u5206\u4EAB\u5230\u5FAE\u4FE1",
              openType: "share",
  ...
  var text = /* @__PURE__ */ _export_sfc(_sfc_main3, [["render", _sfc_render3], ["styles", [_style_03]], ["__file", "C:/Users/13179/Documents/HBuilderProjects/wu-ui/pages/componentsC/text/text.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/componentsC/text/text";
    let __pageQuery = {};
    try {
