...
(() => {
  ...
  // ../../../Documents/HBuilderProjects/wu-ui/unpackage/dist/dev/.nvue/pages/componentsB/actionSheet/actionSheet.js
  ...
  function _sfc_render4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_u_action_sheet = (0, import_vue5.resolveComponent)("u-action-sheet");
    return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("scroll-view", {
      ...
      (0, import_vue5.createElementVNode)("view", { class: "wu-page" }, [
            ...
            ((0, import_vue5.openBlock)(true), (0, import_vue5.createElementBlock)(
              ...
              (0, import_vue5.renderList)($data.list, (item, index2) => {
                return (0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(_component_wu_cell, {
                  onClick: ($event) => $options.openSheet(index2),
                  title: item.title,
                  key: index2,
                  isLink: ""
                }, {
        ...
        (0, import_vue5.createVNode)(_component_u_action_sheet, {
          show: $data.show0,
        ...
        (0, import_vue5.createVNode)(_component_u_action_sheet, {
          ...
          default: (0, import_vue5.withCtx)(() => [
            (0, import_vue5.createElementVNode)("u-text", { style: { "margin": "10px 20px 30px 20px", "color": "#303133", "font-size": "15px" } }, "\u8FD9\u662F\u4E00\u6BB5\u901A\u8FC7slot\u4F20\u5165\u7684\u5185\u5BB9,\u60A8\u53EF\u4EE5\u5728\u6B64\u81EA\u5B9A\u4E49\u64CD\u4F5C\u9762\u677F")
          ]),
          _: 1
          /* STABLE */
        }, 8, ["show"]),
  ...
  var actionSheet = /* @__PURE__ */ _export_sfc(_sfc_main4, [["render", _sfc_render4], ["styles", [_style_04]], ["__file", "C:/Users/13179/Documents/HBuilderProjects/wu-ui/pages/componentsB/actionSheet/actionSheet.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/componentsB/actionSheet/actionSheet";
    let __pageQuery = {};
    try {
