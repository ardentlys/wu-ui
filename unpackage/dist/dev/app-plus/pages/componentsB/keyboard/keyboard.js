...
(() => {
  ...
  // ../../../Documents/HBuilderProjects/wu-ui/unpackage/dist/dev/.nvue/pages/componentsB/keyboard/keyboard.js
  ...
  function _sfc_render4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_u_keyboard = (0, import_vue5.resolveComponent)("u-keyboard");
    return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("scroll-view", {
      ...
      (0, import_vue5.createElementVNode)("view", { class: "wu-page" }, [
            ...
            ((0, import_vue5.openBlock)(true), (0, import_vue5.createElementBlock)(
              ...
              (0, import_vue5.renderList)($data.list, (item, index2) => {
                return (0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(_component_wu_cell, {
                  ...
                  onClick: ($event) => $options.openKeyboard(index2),
                  title: item.title,
                  key: index2,
                  isLink: ""
                }, {
        ...
        (0, import_vue5.createVNode)(_component_u_keyboard, {
  ...
  var keyboard = /* @__PURE__ */ _export_sfc(_sfc_main4, [["render", _sfc_render4], ["styles", [_style_04]], ["__file", "C:/Users/13179/Documents/HBuilderProjects/wu-ui/pages/componentsB/keyboard/keyboard.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/componentsB/keyboard/keyboard";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    keyboard.mpType = "page";
    const app = Vue.createPageApp(keyboard, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...keyboard.styles || []]));
    app.mount("#root");
  }
})();
