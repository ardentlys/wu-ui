...
(() => {
  ...
  // ../../../Documents/HBuilderProjects/wu-ui/unpackage/dist/dev/.nvue/pages/componentsB/toast/toast.js
  var import_vue5 = __toESM(require_vue());
  var _style_04 = { "wu-page": { "": { "paddingTop": 0, "paddingRight": 0, "paddingBottom": 0, "paddingLeft": 0 } }, "wu-cell-icon": { "": { "width": "36rpx", "height": "36rpx", "marginRight": "8rpx" } }, "wu-cell-group__title__text": { "": { "fontWeight": "bold" } } };
  var _sfc_main4 = {
    data() {
      return {
        show: false,
    ...
    methods: {
      showToast(params) {
        this.$refs.uToast.show(__spreadProps(__spreadValues({}, params), {
          complete() {
  ...
  function _sfc_render4(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_u_gap = (0, import_vue5.resolveComponent)("u-gap");
    const _component_u_toast = (0, import_vue5.resolveComponent)("u-toast");
    ...
    return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("scroll-view", {
      ...
      (0, import_vue5.createElementVNode)("view", { class: "wu-page" }, [
        (0, import_vue5.createVNode)(_component_u_gap, {
          height: "30",
          bgColor: "#fff"
        }),
        ...
        (0, import_vue5.createVNode)(_component_wu_cell_group, { "title-bg-color": "rgb(243, 244, 246)" }, {
            ...
            ((0, import_vue5.openBlock)(true), (0, import_vue5.createElementBlock)(
              ...
              (0, import_vue5.renderList)($data.list, (item, index2) => {
                return (0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(_component_wu_cell, {
                  ...
                  default: (0, import_vue5.withCtx)(() => [
                    (0, import_vue5.createCommentVNode)(' <image\r\n				    slot="icon"\r\n				    class="wu-cell-icon"\r\n				    :src="getIcon(item.icon)"\r\n				    mode="widthFix"\r\n				></image> ')
                  ]),
                  _: 2
                  /* DYNAMIC */
  ...
  var toast2 = /* @__PURE__ */ _export_sfc(_sfc_main4, [["render", _sfc_render4], ["styles", [_style_04]], ["__file", "C:/Users/13179/Documents/HBuilderProjects/wu-ui/pages/componentsB/toast/toast.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/componentsB/toast/toast";
    let __pageQuery = {};
    try {
    ...
    toast2.mpType = "page";
    const app = Vue.createPageApp(toast2, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...toast2.styles || []]));
    app.mount("#root");
  }
})();
