...
(() => {
  ...
  // ../../../Documents/HBuilderProjects/wu-ui/unpackage/dist/dev/.nvue/pages/componentsB/notify/notify.js
  ...
  var _sfc_main4 = {
    ...
    methods: {
      openNotify(params) {
        this.$refs.uNotify.show(__spreadValues({}, params));
      }
    }
  };
  function _sfc_render4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_u_notify = (0, import_vue5.resolveComponent)("u-notify");
  ...
  var notify = /* @__PURE__ */ _export_sfc(_sfc_main4, [["render", _sfc_render4], ["styles", [_style_04]], ["__file", "C:/Users/13179/Documents/HBuilderProjects/wu-ui/pages/componentsB/notify/notify.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/componentsB/notify/notify";
    let __pageQuery = {};
    try {
    ...
    notify.mpType = "page";
    const app = Vue.createPageApp(notify, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...notify.styles || []]));
    app.mount("#root");
  }
})();
