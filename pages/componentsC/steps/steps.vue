<template>
	<view class="wu-page">
		<view class="wu-demo-block">
			<text class="wu-demo-block__title">基础演示</text>
		...
		<view class="wu-demo-block">
			<text class="wu-demo-block__title">显示点类型</text>
			<view class="wu-demo-block__content">
				<u-steps
				    :current="1"
				    dot
		...
		<view class="wu-demo-block">
			<text class="wu-demo-block__title">错误状态</text>
			<view class="wu-demo-block__content">
				<u-steps :current="1">
					<u-steps-item
					    title="已下单"
		...
		<view class="wu-demo-block">
			<text class="wu-demo-block__title">自定义插槽</text>
			<view class="wu-demo-block__content">
				<u-steps :current="1">
					<u-steps-item
					    title="已下单"
		...
		<view class="wu-demo-block">
			<text class="wu-demo-block__title">竖向展示</text>
			<view class="wu-demo-block__content">
				<u-steps
				    :current="1"
				    direction="column"
